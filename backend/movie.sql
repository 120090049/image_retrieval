...
TRUNCATE TABLE movietype;
TRUNCATE TABLE mtype;
TRUNCATE TABLE user;
...
INSERT INTO `movie` (`MID`,`name`,`year`,`boxOffice`,`country`,`totalFrame`,`frameRate`, `mark`, `reviewers`, `DID`,`totalTime`)
VALUES
  (1,"The Shawshank Redemption",1994,28767189,"America",720,23.9760239,9.3,2812705,1,7200);
